...
ListErroFile = ['ATTACK_ATTACK_ATTACK_0_47_new.mp4','ATTACK_ATTACK_ATTACK_3_301.mp4','ATTACK_ATTACK_ATTACK_1_140.mp4','ATTACK_ATTACK_ATTACK_0_51.mp4',
                'TURTLE_BEACH_GIVEAWAYS_2_78.mp4','TURTLE_BEACH_GIVEAWAYS_0_49.mp4','PUBG_ALL_DAY_0_143.mp4','TURTLE_BEACH_GIVEAWAYS_4_86.mp4','TURTLE_BEACH_GIVEAWAYS_0_271.mp4']
ListErrorStart = ['ATTACK_ATTACK_ATTACK_1_135.mp4','ATTACK_ATTACK_ATTACK_1_136.mp4','ATTACK_ATTACK_ATTACK_1_137.mp4',
                'ATTACK_ATTACK_ATTACK_1_140.mp4','ATTACK_ATTACK_ATTACK_3_41.mp4','ATTACK_ATTACK_ATTACK_3_53.mp4','PUBG_ALL_DAY_0_118.mp4',
                'PUBG_ALL_DAY_0_119.mp4','PUBG_ALL_DAY_0_125.mp4','PUBG_ALL_DAY_0_145.mp4']
Threshold_MaxYaw  = 15
...
def filterClips(emotion_in,duration_in,featureClips,idChoosen):
    ...
    for keyFilename in featureClips.keys():
        ...
        conditionBasePose = (startYaw <=5 and startPitch<=5 and
                            startRoll<=5 and endYaw<=5 and 
                            endPitch<=5 and endRoll<=5)
        ...
        if idChoosen == 0:
            if (distance1 <= 50 and distance2<=80 and emotion_in == emotion  and duration <= duration_in and 
                ...
                featureClips[keyFilename]['NumberNeighborhood']>0 and (startYaw<=2 and startPitch<=2 and startRoll<=2 and startYaw>=-2 and startPitch>=-2 and startRoll>=-2)
                and keyFilename not in ListErrorStart) or (distance1 <= 50 and distance2<=80 and emotion == 'NeutralNonspeaking'  and duration <= duration_in and 
                conditions and conditionBasePose and
                featureClips[keyFilename]['NumberNeighborhood']>0  and ( startYaw<=2 and startPitch<=2 and startRoll<=2 and startYaw>=-2 and startPitch>=-2 and startRoll>=-2)and keyFilename not in ListErrorStart):
...
def main():
    ...
    if dataJson['influencer'] == 'DrDisrespect':
        ...
        mode = 'Normal'
    f = open(os.path.join('/home/ubuntu/DrivingClipsModule/Config','DrDisrespectConfig.json'))
    config = json.load(f)
