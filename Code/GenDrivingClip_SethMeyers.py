...
import time
startTime = time.time()
with open('/home/ubuntu/DrivingClipsModule/DataBase/SethMeyers/StartListVideo.json') as json_file:
    dataStart = json.load(json_file)
with open('/home/ubuntu/DrivingClipsModule/DataBase/SethMeyers/ErrorVideoList.txt') as f:
    ListErroFile = [line.rstrip() for line in f]
Threshold_MaxYaw  = 10
Threshold_MaxPitch = 10
Threshold_MaxRoll  = 10
Threshold_MinYaw   = -10
Threshold_MinPitch = -10
Threshold_MinRoll =-10
...
def main():
    ...
    if dataJson['influencer'] == 'DrDisrespect':
        ...
        mode = 'Normal'
    f = open(os.path.join('/home/ubuntu/DrivingClipsModule/Config','SethMeyersConfig.json'))
    config = json.load(f)
